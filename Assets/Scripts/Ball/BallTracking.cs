...
{
    [SerializeField] private Vector3 _derectionOffset;
    ...
    private void TrackBall()
    {
        ...
        _cameraPosition = _ball.transform.position;
        Vector3 derection = (beamPosition - _ball.transform.position).normalized + _derectionOffset;
        _cameraPosition -= derection * _lenght;
